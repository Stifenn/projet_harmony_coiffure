...
<head>
  ...
  <!--<link rel="stylesheet" href="<?= $this->assetUrl('css/css_theme_front/bootstrap.min.css')?>">-->
...
<!--///////////////////////////////////////////////////////
        ...
        <div class="wrap">
          ...
          <div class="footer-social">
            <div class="fotter-social-wrap">
              <a href="https://www.facebook.com/"><img class="fotter-social" src="<?=$this->assetUrl('images/social/Facebook.png')?>" alt="52dd249c929b601f5400054c_Facebook.png"></a>
              <a href="https://www.twitter.com/"><img class="fotter-social" src="<?=$this->assetUrl('images/social/Twitter.png')?>" alt="52dd24f2929b601f54000551_Twitter.png"></a>
              <a href="https://plus.google.com/"><img class="fotter-social" src="<?=$this->assetUrl('images/social/Google-plus.png')?>" alt="52dd26a55b54031d540005af_Google-plus.png"></a>
              <a href="https://www.blogger.com/"><img class="fotter-social" src="<?=$this->assetUrl('images/social/Blogger.png')?>" alt="52de52e7b6d2171f78000414_Blogger.png"></a>
              <a href="https://www.digg.com/"><img class="fotter-social" src="<?=$this->assetUrl('images/social/Digg.png')?>" alt="52de53174702a71e780003c3_Digg.png"></a>
              <a href="https://www.pinterest.com/"><img class="fotter-social" src="<?=$this->assetUrl('images/social/Pinterest.png')?>" alt="52de533c5d3566c1430003e9_Pinterest.png"></a>
              <a href="https://www.flicker.com/"><img class="fotter-social" src="<?=$this->assetUrl('images/social/Flickr.png')?>" alt="52de535f1b42bfc24300049e_Flickr.png"></a>
              <a href="https://www.vimeo.com/"><img class="fotter-social" src="<?=$this->assetUrl('images/social/Vimeo.png')?>" alt="52de537cb6d2171f7800041c_Vimeo.png"></a>
              <a href="https://www.myspace.com/"><img class="fotter-social" src="<?=$this->assetUrl('images/social/Myspace.png')?>" alt="52de53954702a71e780003c5_Myspace.png"></a>
              <a href="https://www.stumbleupon.com/"><img class="fotter-social" src="<?=$this->assetUrl('images/social/Stumbleupn.png')?>" alt="52de53c0b6d2171f7800041e_Stumbleupn.png"></a>
              <a href="https://www.tumblr.com/"><img class="fotter-social" src="<?=$this->assetUrl('images/social/Tumblr.png')?>" alt="52de54021b42bfc2430004a3_Tumblr.png"></a>
              <a href="https://www.youtube.com/"><img class="fotter-social" src="<?=$this->assetUrl('images/social/Youtube.png')?>" alt="52de54495d3566c14300040a_Youtube.png"></a>
            </div>
          </div>
          <div>
  ...
  <script src="<?= $this->assetUrl('js/js_theme_frontclassie.js')?>"></script>
